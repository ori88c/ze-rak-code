...
This repository contains my personal proofs and solutions to selected LeetCode problems. It includes only problems where I believe my solution or reasoning offers more than what can typically be found on the internet - whether through a clean proof, strong readability, or an efficient algorithmic approach.

All solutions are self-authored (**not generated by AI** or automated tools). Most include a dedicated README with a full explanation of the reasoning, except when the core challenge is code clarity rather than algorithmic depth.
...
- Thought process
- Intermediate observations, each backed by reasoning
