...
- [Key Observations](#key-observations)
  - [Observation 1 — Any pair of negatives can be eliminated](#observation-1)
  - [Observation 2 — Even count of negatives yields all-positive solution](#observation-2)
  - [Observation 3 — Odd count leaves exactly one negative, optimally placed at MAV](#observation-3)
- [Algorithm Outline](#algorithm)
- [Correctness Sketch](#correctness)
- [Complexity](#complexity)
- [Why No Code Attached](#why-no-code)
