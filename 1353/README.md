...
- [Key Observations](#key-observations)
  - [Observation 1 — Unique starts/ends are easy](#observation-1)
  - [Observation 2 — Identical spans](#observation-2)
  - [Observation 3 — Same start, different ends ⇒ process by smallest end](#observation-3)
  - [Observation 4 — One allocation per day iteration](#observation-4)
